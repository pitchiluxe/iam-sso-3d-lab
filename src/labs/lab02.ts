...
export const LAB_02: Lab = {
  ...
  brief: 'Process three HR tickets: onboard Alex Morgan, transfer Jane Doe to Engineering, and terminate Bob Sato.',
  durationMinutes: 45,
  ...
  objectives: [
    ...
    { id: 'o4', description: 'Verify no stale access after moves',     points: 5,  category: 'troubleshoot' },
    { id: 'o5', description: 'Collect session revocation evidence',     points: 5,  category: 'evidence' },
    { id: 'o6', description: 'Document all actions in the change log', points: 5,  category: 'docs' },
  ],
  steps: [
    {
      id: 's1',
      title: 'Resolve onboarding ticket for Alex Morgan',
      brief: 'Open the "Onboard Alex Morgan" ticket in the Help Desk console. Create Alex\'s account, add to grp-finance-payroll, verify sign-in to Finance Portal.',
    ...
    },
    {
      ...
      brief: 'Open the transfer ticket. Remove Jane from grp-finance-payroll and grp-finance-analysts. Add to grp-engineering-dev. Verify Jane can no longer access Finance Portal.',
      validator: { kind: 'user-moved', params: { userId: 'jane.doe' } },
      evidence: [{ kind: 'log-excerpt', capture: 'auto', params: { count: 5 } }],
      tutorPrompts: ['What is the smallest set of actions that would have left Jane with stale HR access?'],
      hintIds: ['lab02.s2.h1'],
    ...
    },
    {
      ...
      brief: 'Open the termination ticket. Disable Bob\'s account. Revoke all active sessions. Remove from all groups. Verify Bob cannot sign in.',
