...
export const LAB_04: Lab = {
  ...
  brief: 'Configure single sign-on for the Finance Portal (SAML) and Help Desk Portal (OIDC). Map identity claims.',
  durationMinutes: 50,
  zoneIds: ['iam-ops', 'app-center'],
  startingZone: 'iam-ops',
  startingSeed: 'lab04',
  objectives: [
    { id: 'o1', description: 'Configure Finance Portal as SAML client',  points: 10, category: 'exec' },
  ...
  steps: [
    {
      ...
      brief: 'In the IAM Console, configure the Finance Portal: protocol SAML, entity ID urn:finance.northwind.example, redirect URI https://finance.northwind.example/callback.',
    ...
    },
    {
      ...
      brief: 'Configure Help Desk: protocol OIDC, redirect URI https://helpdesk.northwind.example/callback, issuer https://idp.northwind.example/realms/northwind.',
    ...
    },
    {
      ...
      brief: 'Map the role claim from the IdP to grp-helpdesk-tier1 for the Help Desk Portal. Test that Dan can reach the portal.',
    ...
    },
    {
      ...
      brief: 'Sign in as Erin Cho and reach both Finance Portal and Help Desk without re-entering credentials.',
