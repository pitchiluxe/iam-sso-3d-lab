...
export const LAB_09: Lab = {
  ...
  brief:
    "Remove Hank's standing domain admin privilege. Implement a time-limited elevation workflow with manager approval.",
  durationMinutes: 40,
  ...
  steps: [
    ...
    },
    {
      ...
      brief:
        "Submit a privilege elevation request for Hank. Wait for Ivy Park's approval. Record the approval.",
    ...
    },
    {
      ...
      brief:
        'Write up the PAM policy: who can request, who approves, duration, and audit requirements.',
