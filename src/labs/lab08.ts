  ...
  steps: [
    {
      ...
      brief:
        'Review the audit events. Three failed sign-ins from foreign ASN 203.0.113.42, then one success. Identify the affected account.',
    ...
    },
    {
      ...
      brief:
        "Disable Jane's account. Revoke all active sessions. Reset her credentials and MFA enrollment.",
    ...
    },
    {
      ...
      brief:
        'Search the audit log for any other accounts with activity from ASN 203.0.113.42. Check for privilege escalation.',
