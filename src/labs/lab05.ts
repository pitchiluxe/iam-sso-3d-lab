...
export const LAB_05: Lab = {
  ...
  brief: 'Enforce MFA for privileged users. Fix a repeated MFA prompt issue. Block a foreign ASN sign-in.',
  durationMinutes: 40,
  ...
  objectives: [
    ...
    { id: 'o4', description: 'Set and test conditional access policy', points: 10, category: 'exec' },
  ...
  steps: [
    ...
    },
    {
      ...
      brief: 'Erin reports being prompted for MFA repeatedly. Diagnose via sign-in logs. Fix the issue.',
      validator: { kind: 'mfa-challenge-completed', params: { userId: 'erin.cho' } },
      evidence: [{ kind: 'log-excerpt', capture: 'auto', params: { count: 5 } }],
      tutorPrompts: ['What log fields distinguish a genuine failure from a loop caused by misconfiguration?'],
      hintIds: ['lab05.s3.h1'],
    ...
    },
    {
      ...
      brief: 'Block sign-ins from a foreign ASN. Verify the policy is evaluated correctly in a simulated block.',
  ...
  faults: [{ id: 'f1', kind: 'mfa-prompt-loop', applyAtStep: 's3', params: {}, targetUserId: 'erin.cho' as UserId }],
  debriefQuestions: [
