...
const SSO_FAULTS: FaultKind[] = [
  ...
  'wrong-client-secret', 'wrong-claim-mapping', 'clock-skew', 'dns-resolution',
];
...
export const LAB_07: Lab = {
  ...
  brief: 'At 09:05 AM employees report authentication errors on the Finance Portal. Triage, diagnose, and fix the SSO fault.',
  durationMinutes: 40,
  zoneIds: ['iam-ops', 'app-center', 'sec-ops'],
  startingZone: 'iam-ops',
  startingSeed: 'lab07',
  objectives: [
    { id: 'o1', description: 'Triage and reproduce the issue',    points: 5,  category: 'troubleshoot' },
  ...
  steps: [
    ...
    },
    {
      ...
      brief: 'Compare the Finance Portal config against the baseline. Check IdP authentication logs. Verify DNS resolution and clock skew.',
    ...
    },
    {
      ...
      tutorPrompts: ['What is the difference between the wrong issuer and a wrong redirect URI as failure modes?'],
      hintIds: ['lab07.s3.h1'],
      points: { exec: 5 },
    },
    {
      ...
      brief: 'Sign in as Dan Rivera (normal) and Erin Cho (privileged) — both must succeed. Document root cause and remediation.',
  ...
  faults: [{ id: 'f1', kind: LAB_07_FAULT, applyAtStep: 's1', params: {}, targetAppId: 'app-finance' as AppId }],
  debriefQuestions: [
