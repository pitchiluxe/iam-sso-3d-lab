...
export const LAB_01: Lab = {
  ...
  startingSeed: 'lab01',
  objectives: [
    { id: 'o1', description: 'Create 5 security groups', points: 10, category: 'exec' },
    { id: 'o2', description: 'Create 5 baseline users', points: 10, category: 'exec' },
    { id: 'o3', description: 'Configure IdP realm', points: 10, category: 'exec' },
    { id: 'o4', description: 'Apply baseline password policy', points: 10, category: 'exec' },
    { id: 'o5', description: 'Verify user can authenticate', points: 10, category: 'exec' },
    { id: 'o6', description: 'Troubleshoot an auth failure', points: 10, category: 'troubleshoot' },
    { id: 'o7', description: 'Document the authorization model', points: 20, category: 'docs' },
    { id: 'o8', description: 'Collect evidence snapshots', points: 10, category: 'evidence' },
    {
      id: 'o9',
      description: 'Use least-privilege naming',
      points: 10,
  ...
  steps: [
    {
      ...
      points: { exec: 8, troubleshoot: 4, docs: 6 },
    },
    {
      id: 's2',
    ...
    },
    {
      ...
      hintIds: ['lab01.s5.h1'],
      points: { exec: 10, evidence: 10, docs: 10 },
    },
  ],
  faults: [],
  debriefQuestions: [
