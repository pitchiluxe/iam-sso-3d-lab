  ...
  steps: [
    {
      ...
      brief: 'Create 5 OUs (Users, Groups, Computers, Servers, ServiceAccounts) and 5 security groups (grp-hr-readers, grp-finance-payroll, grp-engineering-dev, grp-helpdesk-tier1, grp-iam-admins).',
      validator: { kind: 'group-added', params: { groupId: 'grp-iam-admins' } },
    ...
    },
    {
      ...
      brief: 'Create 5 test users (Alex Morgan, Bob Sato, Cara Patel, Dan Rivera, Erin Cho). Assign each to their department group. Leave MFA disabled for now.',
      validator: { kind: 'user-created', params: { userId: 'alex.morgan' } },
      evidence: [{ kind: 'snapshot', capture: 'manual', params: { console: 'iamConsole' } }],
      tutorPrompts: ['How will you prove the user was actually created, not just added to a spreadsheet?'],
      hintIds: ['lab01.s2.h1'],
    ...
    },
    {
      ...
      brief: 'Configure the IdP realm "northwind" with default settings. Create the admin user and set the admin password.',
    ...
    },
    {
      ...
      brief: 'Set a minimum password length of 12 characters and require MFA for all privileged role holders.',
      validator: { kind: 'mfa-challenge-completed', params: {} },
    ...
    },
    {
      ...
      brief: 'Sign in as admin and capture the resulting session in the audit log. Take a screenshot of the session details.',
      ...
      tutorPrompts: ['How will you prove the user actually authenticated and is not just a record in a list?'],
      hintIds: ['lab01.s5.h1'],
