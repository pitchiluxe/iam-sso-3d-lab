 ...
 *  - The start screen appears with all 26 lab cards
 *  - Clicking a lab card starts the lab and the HUD updates
 */
import { test, expect } from '@playwright/test';

test('app boots, start screen renders 26 lab cards, starting a lab updates the HUD', async ({ page }) => {
  ...
  // Start screen shows all 26 lab cards
