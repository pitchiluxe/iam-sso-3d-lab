 ...
 *  - The start screen appears with all 17 lab cards
 *  - Clicking a lab card starts the lab and the HUD updates
 */
import { test, expect } from '@playwright/test';

test('app boots, start screen renders 17 lab cards, starting a lab updates the HUD', async ({ page }) => {
  ...
  // Start screen shows all 17 lab cards
